...
const dataAnalyticsCourse = {
  ...
  rating: 4.9,
  learners: "150k+",
  skills: ["Excel", "SQL", "Python", "NumPy", "Pandas", "Matplotlib", "Seaborn", "Statistics", "PowerBI"],
  jobRoles: ["Data Analyst", "Business Analyst", "BI Developer"],
  source: {
      ...
      lectures: [
        {
          ...
          topics: ["Excel Formulas (VLOOKUP, XLOOKUP, INDEX/MATCH)", "Pivot Tables & Pivot Charts", "Data Cleaning in Excel", "Conditional Formatting & Dashboards"],
          ...
          fundamentalQuestions: [
            {
              ...
              options: ["XLOOKUP", "HLOOKUP", "SUMIF", "CONCATENATE"],
              correctAnswer: 0,
            ...
            },
            {
              ...
              options: ["Summarize, aggregate, and analyze large datasets interactively", "Write VBA macros", "Protect workbooks with passwords", "Draw vector shapes"],
              correctAnswer: 0,
            ...
            },
            {
              ...
              options: ["It doesn't break when columns are inserted or reordered and looks up to the left", "It runs faster on CPUs", "It uses less disk space", "It translates languages"],
              correctAnswer: 0,
            ...
            },
            {
              ...
              options: ["Counts cells in range A2:A100 containing numerical values strictly greater than 50", "Sums values greater than 50", "Multiplies cells by 50", "Deletes numbers less than 50"],
              correctAnswer: 0,
            ...
            },
            {
              ...
              options: ["Transforms wide crosstab columns into tabular attribute-value rows suitable for analysis", "Reverses text alphabetically", "Deletes duplicate rows", "Exports data to PDF"],
              correctAnswer: 0,
        ...
        },
        {
          ...
          topics: ["SELECT, WHERE, ORDER BY, GROUP BY, HAVING", "SQL JOINs (INNER, LEFT, RIGHT, FULL)", "Aggregate Functions & Subqueries", "Window Functions (ROW_NUMBER, RANK, DENSE_RANK, LAG/LEAD)"],
          assessment: { totalQuestions: 10, fundamentalQuestions: 5, codingQuestions: 5 },
          fundamentalQuestions: [
            {
              id: "da-02-f-01",
      ...
      lectures: [
        {
          ...
          topics: ["Python Data Structures (Lists, Tuples, Dictionaries, Sets)", "List Comprehensions & Lambdas", "Functions, Args & Kwargs", "Exception Handling & File I/O"],
          assessment: { totalQuestions: 10, fundamentalQuestions: 5, codingQuestions: 5 },
          fundamentalQuestions: [
            {
              id: "da-03-f-01",
              ...
              options: ["Lists are mutable (can be modified); Tuples are immutable (cannot be changed after creation)", "Tuples can only store numbers", "Lists have fixed length", "Tuples cannot be indexed"],
              correctAnswer: 0,
            ...
            },
            {
              ...
              options: ["Passing a variable number of non-keyword positional arguments as a tuple", "Pointers in memory", "Multiplication of function returns", "Mandatory keyword arguments"],
              correctAnswer: 0,
            ...
            },
            {
              ...
              options: ["It uses `yield` to return values lazily one at a time, conserving memory for large sequences", "It generates random numbers automatically", "It compiles code to C", "It cannot be called in loops"],
              correctAnswer: 0,
            ...
            },
            {
              ...
              options: ["It prevents multiple native threads from executing Python bytecodes simultaneously in CPython", "It locks files on disk during writing", "It encrypts variable values", "It speeds up numpy operations"],
              correctAnswer: 0,
        ...
        },
        {
          ...
          topics: ["NumPy Ndarray Creation & Indexing", "Broadcasting Rules in NumPy", "Vectorized Array Math & Slicing", "Linear Algebra with np.linalg"],
          assessment: { totalQuestions: 10, fundamentalQuestions: 5, codingQuestions: 5 },
          fundamentalQuestions: [
            {
              id: "da-04-f-01",
            ...
            },
            {
              ...
              options: ["np.dot(A, B) or A @ B", "A * B", "np.multiply(A, B)", "A.cross(B)"],
              correctAnswer: 0,
        ...
        },
        {
          ...
          topics: ["Series & DataFrame Architecture", "Data Cleaning, Handling Missing Values & Duplicates", "Filtering, Loc & Iloc Indexing", "GroupBy, Merge & Reshaping Data"],
          assessment: { totalQuestions: 10, fundamentalQuestions: 5, codingQuestions: 5 },
          fundamentalQuestions: [
            {
              id: "da-05-f-01",
      ...
      lectures: [
        {
          ...
          topics: ["Line, Bar, Scatter & Histogram Plots", "Subplots & Figure Customization", "Seaborn Statistical Plots (Boxplot, Heatmap, Violinplot)", "Color Palettes & Styling"],
          assessment: { totalQuestions: 10, fundamentalQuestions: 5, codingQuestions: 5 },
          fundamentalQuestions: [
            {
              id: "da-06-f-01",
              ...
              options: ["Histogram / KDE plot", "Pie chart", "Network graph", "Stacked column plot"],
              correctAnswer: 0,
            ...
            },
            {
              ...
              options: ["Seaborn Heatmap with annotated values", "Line chart", "Donut chart", "Radar chart"],
              correctAnswer: 0,
            ...
            },
            {
              ...
              options: ["A tuple containing the Figure object and an Axes array", "A single image file", "A Pandas dataframe", "A database connection"],
              correctAnswer: 0,
        ...
        },
        {
          ...
          topics: ["Descriptive Statistics (Mean, Median, Mode, Variance, Std)", "Probability Distributions (Normal, Binomial, Poisson)", "Hypothesis Testing, P-values & Null Hypothesis", "A/B Testing & Confidence Intervals"],
          assessment: { totalQuestions: 10, fundamentalQuestions: 5, codingQuestions: 5 },
          fundamentalQuestions: [
            {
              id: "da-07-f-01",
        ...
        },
        {
          ...
          topics: ["Power BI Desktop Interface & Data Ingestion", "Star Schema & Data Modeling", "DAX Formulas (CALCULATE, RELATED, SUMX)", "Interactive Report Design & Drillthrough"],
          assessment: { totalQuestions: 10, fundamentalQuestions: 5, codingQuestions: 5 },
          fundamentalQuestions: [
            {
              id: "da-08-f-01",
            ...
            },
            {
              ...
              options: ["CALCULATE()", "SUM()", "COUNT()", "CONCATENATE()"],
              correctAnswer: 0,
            ...
            },
            {
              ...
              options: ["Star Schema (central fact table linked to surrounding dimension tables)", "Single flat wide table", "Chain of 50 linked tables", "Circular schema"],
              correctAnswer: 0,
...
fs.writeFileSync(path.join(outDir, 'dataAnalyticsCourse.ts'), `import { Course } from '../types';\n\nexport const dataAnalyticsCourseData: Course = ${JSON.stringify(dataAnalyticsCourse, null, 2)};\n`);
console.log("Wrote dataAnalyticsCourse.ts");
