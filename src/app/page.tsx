...
import { User, LogIn, Sparkles, ArrowRight, ShieldCheck, Database, KeyRound } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#070709] text-gray-900 dark:text-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 py-16 max-w-4xl mx-auto">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950/40 border border-blue-200/60 dark:border-blue-800/40 text-blue-600 dark:text-blue-400 text-xs font-bold mb-6">
          ...
          <span>Feature Branch: Authentication & User Profile</span>
        </div>
        ...
        <h1 className="text-4xl sm:text-6xl font-black tracking-tight mb-6 bg-gradient-to-r from-gray-900 via-blue-600 to-indigo-600 dark:from-white dark:via-blue-400 dark:to-indigo-400 bg-clip-text text-transparent">
          Firebase Auth & Cloud Firestore Profile Engine
        </h1>

        <p className="text-gray-600 dark:text-zinc-400 text-lg max-w-2xl mb-10 font-medium leading-relaxed">
          Secure OAuth authentication with Google and GitHub, email/password, and instant Guest exploration. User profile synchronization with skills, target roles, and real-time state persistence.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          <Link
            href="/profile"
            className="px-8 py-4 rounded-2xl bg-white dark:bg-white/10 hover:bg-gray-100 dark:hover:bg-white/15 text-gray-900 dark:text-white font-bold text-base flex items-center gap-2 border border-gray-200 dark:border-white/10 transition-all"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-16 text-left w-full">
          <div className="p-6 rounded-3xl border border-gray-200/80 dark:border-white/10 bg-white/50 dark:bg-white/[0.02] backdrop-blur-xl">
            ...
            <h3 className="font-bold text-base mb-1">Multi-Provider Auth</h3>
            <p className="text-xs text-gray-500 dark:text-zinc-400 leading-relaxed">Google & GitHub OAuth, email registration, and zero-friction guest sessions.</p>
          </div>
          ...
          <div className="p-6 rounded-3xl border border-gray-200/80 dark:border-white/10 bg-white/50 dark:bg-white/[0.02] backdrop-blur-xl">
            ...
            <h3 className="font-bold text-base mb-1">Firestore Realtime Sync</h3>
            <p className="text-xs text-gray-500 dark:text-zinc-400 leading-relaxed">Bidirectional state sync across devices and sessions.</p>
          </div>
          ...
          <div className="p-6 rounded-3xl border border-gray-200/80 dark:border-white/10 bg-white/50 dark:bg-white/[0.02] backdrop-blur-xl">
            ...
            <h3 className="font-bold text-base mb-1">Onboarding Questionnaire</h3>
            <p className="text-xs text-gray-500 dark:text-zinc-400 leading-relaxed">Interactive skill questionnaire and user target career preferences.</p>
          </div>
        </div>
      </main>
    </div>
