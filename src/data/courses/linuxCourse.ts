...
export const linuxCourseData: Course = {
  ...
  "modules": [
    ...
    },
    {
      ...
      "lectures": [
        {
          "lectureId": "linux-lec-04",
          "lectureNumber": 4,
          "title": "Chapter 4: Process Management & Monitoring",
          "videoUrl": "https://www.youtube.com/embed/ldgl9Bd3lLg",
          "topics": [
            "Listing Processes (`ps aux`, `pstree`)",
            "Interactive Task Manager (`top`, `htop`)",
            "Terminating Processes (`kill`, `kill -9`, `pkill`)",
          ...
          "fundamentalQuestions": [
            {
              ...
              "options": [
                "Process Identifier: a unique numerical identifier assigned to each running process by the kernel",
                "Program Instruction Descriptor",
        ...
        {
          "lectureId": "linux-lec-06",
          "lectureNumber": 6,
          "title": "Chapter 6: Networking, SSH & Shell Scripting",
          "videoUrl": "https://www.youtube.com/embed/ldgl9Bd3lLg",
          "topics": [
            "Network Diagnostics (`ping`, `netstat`, `ss`, `curl`)",
            "Remote Access via SSH & Key-Based Authentication",
            "File Transfer with `scp` and `rsync`",
            "Bash Scripting Basics (Variables, If, Loops, Shebang)"
          ],
          "assessment": {
            "totalQuestions": 10,
            "fundamentalQuestions": 5,
